...
最終更新: 2026-07-10（ERT 全面刷新・Mode A/B 文脈型・スキーマ v1.2.0）
...
| `data/current/items.json` | **11 件**（うち **8 件**に公式 contexts×5、schema **1.2.0**） |
| UI | **ERT トーン**。Mode A 文脈読解 / Mode B 下線穴埋め（出題は contexts 付き 8 件） |
| A2 本生成（2,430 件） | **未着手**（新 UX での情報充足度評価待ち） |
| Phase 2 残り | SRS / Mode C / checkmark×新評価統合 |
...
│   ├── components/                    #   layout, guide-modal, item-detail-modal, checkmark-row
