...
最終更新: 2026-07-11（v8 Mode A/B モバイル最適化）
...
| `data/current/items.json` | **21 件** + Insight 公式 3・schema **1.2.3**（nuance_contrast・例文スロット空） |
| UI | ERT トーン + v8 Mode A/B（モバイル縦スクロール・タイマー等削除） |
| EPT 参照 | `data/reference/ept/` |
| A2 本生成（2,430 件） | **未着手**（例文補充・confusables 役割整理待ち） |
...
│   │   └── items.json                 #   現状 21 件 + insights 公式 3（schema 1.2.3）
