...
最終更新: 2026-07-09（パイロット v4・GAS 暫定 @18）
...
| 12 | `doc/handoff/pilot-v4-handoff-report.md` | パイロット v4（scene-config・禁止語・DoD NG） |
...
| GAS 本番 | **暫定 @18**（`AKfycbymECuc...`）。@19 は 404 — 手動デプロイ要（`pilot-v4-handoff-report.md`） |
| `data/current/items.json` | **11 件**（サンプル 3 + パイロット v2 の 8・未更新） |
| A2 本生成（2,430 件） | **未着手**（パイロット v4: コード main 済・**DoD 未達**・GO 待ち） |
